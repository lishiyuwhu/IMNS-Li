...
with tf.device('/cpu:0'):
    ...
    x_train_, y_train_ = read_and_decode("train_Mnist_pgm.tfrecords")
    ...
    x_test_, y_test_ = read_and_decode("test_Mnist_pgm.tfrecords")
    ...
    ## train
    train_num = sum(1 for _ in tf.python_io.tf_record_iterator("train_Mnist_pgm.tfrecords"))
    test_num = sum(1 for _ in tf.python_io.tf_record_iterator("test_Mnist_pgm.tfrecords"))
